...
clang++ -m64 -static -O3 -DNDEBUG -std=gnu++11 -o ../bin/BSD/x86_64/igrow ../obj/BSD/x86_64/thread_pool.o ../obj/BSD/x86_64/operation.o ../obj/BSD/x86_64/ligand.o ../obj/BSD/x86_64/main.o -L/home/hjli/boost_1_48_0/lib/x86_64 -pthread -lboost_system -lboost_thread -lboost_filesystem -lboost_program_options
...
clang++ -m32 -static -O3 -DNDEBUG -std=gnu++11 -o ../bin/BSD/x86/igrow ../obj/BSD/x86/thread_pool.o ../obj/BSD/x86/operation.o ../obj/BSD/x86/ligand.o ../obj/BSD/x86/main.o -L/home/hjli/boost_1_48_0/lib/x86 -pthread -lboost_system -lboost_thread -lboost_filesystem -lboost_program_options
