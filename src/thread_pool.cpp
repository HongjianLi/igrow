...
namespace igrow
{
	thread_pool::thread_pool(const size_t num_threads) : num_threads(num_threads), tasks_ptr(nullptr), num_tasks(0), num_started_tasks(0), num_completed_tasks(0), exiting(false)
	{
