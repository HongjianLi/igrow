...
main(int argc, char* argv[])
{
	...
	size_t num_threads, seed, num_generations, num_elitists, num_mutants, num_crossovers, max_heavy_atoms, max_hb_donors, max_hb_acceptors;
	...
	// Process program options.
	{
		...
		miscellaneous_options.add_options()
			...
			("crossovers", value<size_t>(&num_crossovers)->default_value(default_num_crossovers), "number of child ligands generated by crossover")
